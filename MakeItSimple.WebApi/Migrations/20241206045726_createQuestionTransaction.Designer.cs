...
namespace MakeItSimple.WebApi.Migrations
{
    ...
    [Migration("20241206045726_createQuestionTransaction")]
    partial class createQuestionTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Setup.Phase_Two.QuestionTransactionId", b =>
                {
                    ...
                    b.Property<int>("PmsQuestionId")
                        .HasColumnType("int")
                        .HasColumnName("pms_question_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_question_transaction_id");

                    b.HasIndex("PmsQuestionaireId")
                        .HasDatabaseName("ix_question_transaction_id_pms_questionaire_id");

                    b.HasIndex("PmsQuestionaireModuleId")
                        .HasDatabaseName("ix_question_transaction_id_pms_questionaire_module_id");

                    b.ToTable("question_transaction_id", (string)null);
                });
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Setup.Phase_Two.QuestionTransactionId", b =>
                {
                    ...
                    b.HasOne("MakeItSimple.WebApi.Models.Setup.Phase_Two.PmsQuestionaireModule", "PmsQuestionaireModule")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_question_transaction_id_pms_questionaire_modules_pms_questionaire_module_id");
