...
namespace MakeItSimple.WebApi.Migrations
{
    ...
    [Migration("20250522055333_NewTicketingTable")]
    partial class NewTicketingTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Ticketing.Tickets", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("AddedBy")
                        .HasDatabaseName("ix_tickets_added_by");

                    b.HasIndex("BackJobId")
                        .HasDatabaseName("ix_tickets_back_job_id");

                    b.HasIndex("BusinessUnitId")
                        .HasDatabaseName("ix_tickets_business_unit_id");

                    b.HasIndex("CategoryId")
                        .HasDatabaseName("ix_tickets_category_id");

                    b.HasIndex("ChannelId")
                        .HasDatabaseName("ix_tickets_channel_id");
                    ...
                    b.HasIndex("LocationId")
                        .HasDatabaseName("ix_tickets_location_id");

                    b.HasIndex("ModifiedBy")
                        .HasDatabaseName("ix_tickets_modified_by");

                    b.HasIndex("SubCategoryId")
                        .HasDatabaseName("ix_tickets_sub_category_id");

                    b.HasIndex("SubUnitId")
                        .HasDatabaseName("ix_tickets_sub_unit_id");

                    b.HasIndex("UnitId")
                        .HasDatabaseName("ix_tickets_unit_id");
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Ticketing.Tickets", b =>
                {
                    b.HasOne("MakeItSimple.WebApi.Models.User", "AddedByUser")
                        .WithMany()
                        .HasForeignKey("AddedBy")
                        .HasConstraintName("fk_tickets_users_added_by");

                    b.HasOne("MakeItSimple.WebApi.Models.Ticketing.Tickets", "BackJob")
                        .WithMany()
                        .HasForeignKey("BackJobId")
                        .HasConstraintName("fk_tickets_tickets_back_job_id");

                    b.HasOne("MakeItSimple.WebApi.Models.Setup.BusinessUnitSetup.BusinessUnit", "BusinessUnit")
                        .WithMany()
                        .HasForeignKey("BusinessUnitId")
                        .HasConstraintName("fk_tickets_business_units_business_unit_id");
                    ...
                    b.HasOne("MakeItSimple.WebApi.Models.Setup.ChannelSetup.Channel", "Channel")
                        .WithMany()
                        .HasForeignKey("ChannelId")
                        .HasConstraintName("fk_tickets_channels_channel_id");

                    b.HasOne("MakeItSimple.WebApi.Models.Setup.CompanySetup.Company", "Company")
                        .WithMany()
                        .HasForeignKey("CompanyId")
                        .HasConstraintName("fk_tickets_companies_company_id");
                    ...
                    b.HasOne("MakeItSimple.WebApi.Models.Setup.LocationSetup.Location", "Location")
                        .WithMany()
                        .HasForeignKey("LocationId")
                        .HasConstraintName("fk_tickets_locations_location_id");

                    b.HasOne("MakeItSimple.WebApi.Models.User", "ModifiedByUser")
                        .WithMany()
                        .HasForeignKey("ModifiedBy")
                        .HasConstraintName("fk_tickets_users_modified_by");

                    b.HasOne("MakeItSimple.WebApi.Models.Setup.SubCategorySetup.SubCategory", "SubCategory")
                        .WithMany()
                        .HasForeignKey("SubCategoryId")
                        .HasConstraintName("fk_tickets_sub_categories_sub_category_id");

                    b.HasOne("MakeItSimple.WebApi.Models.Setup.SubUnitSetup.SubUnit", "SubUnit")
                        .WithMany()
                        .HasForeignKey("SubUnitId")
                        .HasConstraintName("fk_tickets_sub_units_sub_unit_id");

                    b.HasOne("MakeItSimple.WebApi.Models.Setup.UnitSetup.Unit", "Unit")
                        .WithMany()
                        .HasForeignKey("UnitId")
                        .HasConstraintName("fk_tickets_units_unit_id");
