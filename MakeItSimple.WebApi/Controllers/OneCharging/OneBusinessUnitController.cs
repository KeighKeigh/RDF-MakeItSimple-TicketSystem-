...
//    [ApiController]
//    public class OneBusinessUnitController : ControllerBase
//    {
//        public readonly IMediator _mediator;
//        private readonly IConfiguration _config;

//        public OneBusinessUnitController(IMediator mediator)
//        {
//            _mediator = mediator;
//        }
...
//                var apiEndPoint = "https://api-one.rdfmis.com/api/business_unit_api?per_page=10&page=1&pagination=none&status=active";
...
//                {
//                    var existing = await _storeContext.OneBusinessUnits
//                        .FirstOrDefaultAsync(x => x.sync_id == item.Id, cancellationToken);

//                    if (existing == null)
//                    {
//                        var charging = new OneBusinessUnit
//                        {
//                            sync_id = item.Id,
//                            business_unit_code = item.code,
//                            business_unit_name = item.name,
...
//                        await _storeContext.OneBusinessUnits.AddAsync(charging, cancellationToken);
//                    }
//                    else if (existing.UpdatedAt != item.updated_at)
//                    {

//                        existing.business_unit_code = item.code;
//                        existing.business_unit_name = item.name;
...
//                return Result.Success("Business Units synced successfully.");
//            }
...
//            public List<OneBusinessUnitDto>? Data { get; set; }
//        }

//        public class OneBusinessUnitDto
//        {
