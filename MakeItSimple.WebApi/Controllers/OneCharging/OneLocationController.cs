...
//    [ApiController]
//    public class OneLocationController : ControllerBase
//    {
//        public readonly IMediator _mediator;
//        private readonly IConfiguration _config;

//        public OneLocationController(IMediator mediator)
//        {
//            _mediator = mediator;
//        }
...
//            var result = await _mediator.Send(new ImportLocationCommand());
//            return result.IsFailure ? BadRequest(result) : Ok(result);

//        }


//        public class ImportLocationCommand : IRequest<Result> { }

//        public class Handler : IRequestHandler<ImportLocationCommand, Result>
//        {
...
//            public async Task<Result> Handle(ImportLocationCommand request, CancellationToken cancellationToken)
//            {
//                var client = _httpClientFactory.CreateClient();
//                var apiEndPoint = "https://api-one.rdfmis.com/api/location_api?per_page=10&page=1&pagination=none&status=active";
...
//                {
//                    var existing = await _storeContext.OneLocations
//                        .FirstOrDefaultAsync(x => x.sync_id == item.Id, cancellationToken);

//                    if (existing == null)
//                    {
//                        var charging = new OneLocation
//                        {
//                            sync_id = item.Id,
...
//                        await _storeContext.OneLocations.AddAsync(charging, cancellationToken);
//                    }
//                    else if (existing.UpdatedAt != item.updated_at)
//                    {

//                        existing.location_code = item.code;
//                        existing.location_name = item.name;
...
//                return Result.Success("Location synced successfully.");
//            }
