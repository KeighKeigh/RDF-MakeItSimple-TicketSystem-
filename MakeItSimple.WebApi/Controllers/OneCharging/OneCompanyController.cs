...
//    [ApiController]
//    public class OneCompanyController : ControllerBase
//    {
//        public readonly IMediator _mediator;
//        private readonly IConfiguration _config;

//        public OneCompanyController(IMediator mediator)
//        {
//            _mediator = mediator;
//        }
...
//            var result = await _mediator.Send(new ImportCompanyCommand());
//            return result.IsFailure ? BadRequest(result) : Ok(result);

//        }


//        public class ImportCompanyCommand : IRequest<Result> { }

//        public class Handler : IRequestHandler<ImportCompanyCommand, Result>
//        {
...
//            public async Task<Result> Handle(ImportCompanyCommand request, CancellationToken cancellationToken)
//            {
//                var client = _httpClientFactory.CreateClient();
//                var apiEndPoint = "https://api-one.rdfmis.com/api/companies_api?per_page=10&page=1&pagination=none&status=active";
...
//                {
//                    var existing = await _storeContext.OneCompanies
//                        .FirstOrDefaultAsync(x => x.sync_id == item.Id, cancellationToken);

//                    if (existing == null)
//                    {
//                        var charging = new OneCompany
//                        {
//                            sync_id = item.Id,
...
//                        await _storeContext.OneCompanies.AddAsync(charging, cancellationToken);
//                    }
//                    else if (existing.UpdatedAt != item.updated_at)
//                    {

//                        existing.company_code = item.code;
//                        existing.company_name = item.name;
...
//                return Result.Success("Company synced successfully.");
//            }
...
//            public List<OneCompanyDto>? Data { get; set; }
//        }

//        public class OneCompanyDto
//        {
