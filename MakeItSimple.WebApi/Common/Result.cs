namespace MakeItSimple.WebApi.Common
{
    public class Result
    {
        ...
        public static Result<TValue> NotExist<TValue>(TValue values) => new(values, false, true, Error.NotExists);
    ...
    public record Error(string Code, string Message )
    {
        ...
        public static readonly Error NotExists = new("Error.NotExists", "The Items Doesn't Exists.");
