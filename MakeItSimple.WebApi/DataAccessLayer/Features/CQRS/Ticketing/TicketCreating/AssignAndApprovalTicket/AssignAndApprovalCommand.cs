...
namespace MakeItSimple.WebApi.DataAccessLayer.Features.CQRS.Ticketing.TicketCreating.AssignAndApprovalTicket
{
    public partial class AssignAndApprovalConcern
    {
        public class AssignAndApprovalConcernCommand : IRequest<Result>
        {
